...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{capitulos/0-capa_n_contra}
\renewcommand{\glossaryname}{Lista de Siglas}
\printglossaries
\mainmatter

\input{capitulos/1-introdução.tex}
\input{capitulos/7-related.tex}
%\input{capitulos/2-fundamentos}
